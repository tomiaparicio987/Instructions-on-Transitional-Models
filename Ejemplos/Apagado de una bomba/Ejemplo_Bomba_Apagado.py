"""
Simulación: Apagado de una bomba
"""
...
data = tm.Input('Input_BombaApagado.txt')



output_file = 'output_Bomba_Apagado.txt'
...
tm.Viz(
    ...
    videofile  = 'Simulacion_Bomba_Apagado.avi',
    x_max      = pipe.length,
...
print("Video guardado como 'Simulacion_Bomba_Apagado.avi'")
plt.show()
