"""
Simulación: Cierre de Válvula en el medio del tramo y al final.
"""
...
data = tm.Input('Input_Valvula_Inline_End.txt')

# 2. Definir el archivo de salida (coincidente con el OUTPUT del txt)
output_file = 'output_valvula_Inline_End.txt'
...
tm.Viz(
    ...
    videofile  = 'Simulacion_Valvula_Inline_End.avi',
    x_max      = pipe.length,
...
print("Video guardado como 'Simulacion_Valvula_Inline_End.avi'")
plt.show()