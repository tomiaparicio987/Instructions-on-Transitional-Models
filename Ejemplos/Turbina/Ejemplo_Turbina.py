"""
Simulación: Funcionamiento de una turbina
"""
...
# 1. Cargar datos
data = tm.Input('Input_Turbina.txt')
output_file = 'output_turbina.txt'
...
tm.Viz(
    ...
    videofile  = 'Simulacion_Turbina.avi',
    x_max      = pipe.length,
...
print("Video guardado como 'Simulacion_Turbina.avi'")
plt.show()
